class Generator(MasterClass):
    def generate_pid(self):
        ...
        checksum1 = nnc[-2]
        checksum2 = 0 + ((1 + 2 + int(nnc[4]) + int(nnc[6]) + int(nnc[8]) + int(nnc[10]) + int(nnc[12])) +
                         (int(nnc[14]) + int(nnc[16]) + int(nnc[18]) + int(nnc[20]))) * 4
        checksum3 = 0 + ((int(nnc[3]) + int(nnc[5]) + int(nnc[7]) + int(nnc[9]) + int(nnc[11]) + int(nnc[13])) +
                         (int(nnc[15]) + int(nnc[17]) + int(nnc[19] + int(nnc[21]))) * 7
